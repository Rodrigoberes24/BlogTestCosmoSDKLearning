...
const (
	...
	opWeightMsgCreateArt = "op_weight_msg_create_chain"
	// TODO: Determine the simulation weight value
	defaultWeightMsgCreateArt int = 100
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	var weightMsgCreateArt int
	simState.AppParams.GetOrGenerate(simState.Cdc, opWeightMsgCreateArt, &weightMsgCreateArt, nil,
		func(_ *rand.Rand) {
			weightMsgCreateArt = defaultWeightMsgCreateArt
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreateArt,
		blogsimulation.SimulateMsgCreateArt(am.accountKeeper, am.bankKeeper, am.keeper),
	))
